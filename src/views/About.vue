                        ...
                        <div class="login-snip">
                            ...
                            <div class="login-space">
                                ...
                                <div class="sign-up-form">
                                    ...
                                    <div class="group"> <label for="pass" class="label">DOB</label> <input id="pass" type="date" class="input"> </div>
                                    <div class="group"> <label for="pass" class="label">Gender</label> 
                                    <input id="pass" type="radio" name="g"  value="female">Female 
                                    <input id="pass" value="male" name="g" type="radio"  >male </div>
